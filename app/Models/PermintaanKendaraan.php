...
class PermintaanKendaraan extends Model
{
    ...
    protected $allowedFields = ['id','id_user', 'nama', 'email', 'no_hp', 'tanggal_pinjam', 'tanggal_kembali', 'kendaraan', 'jam_pinjam', 'jam_kembali', 'status', 'unit_kerja', 'nama_pic', 'keperluan', 'lampiran'];
